 ...
 *
 * Learning Objectives:
 *   1. Understand the role of @Test â€” marks a method as a test case
 *   2. Use @BeforeEach / @AfterEach â€” run setup/cleanup around every test
 *   3. Use @BeforeAll / @AfterAll  â€” run once for the entire test class
 *   4. Use @DisplayName            â€” give tests human-readable names
 *   5. Use @Disabled               â€” temporarily skip a test
 *
 * Instructions:
...
public class Lab01_BasicAnnotations {
    ...
    // STEP 7 â€” @Disabled
    //
    // @Disabled skips the test entirely â€” useful for work-in-progress tests.
    // Always provide a reason so teammates know why it is skipped.
    // ============================================================
    @Test
    @Disabled("Not implemented yet â€” will enable in Lab02")
